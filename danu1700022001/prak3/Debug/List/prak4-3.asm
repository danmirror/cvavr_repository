...
; 0000 0094 ADMUX=ADC_VREF_TYPE;
	LDI  R30,LOW(96)
	OUT  0x7,R30
; 0000 0095 ADCSRA=(1<<ADEN) | (0<<ADSC) | (0<<ADATE) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (1<<ADPS1) | (0<<ADPS0);
	LDI  R30,LOW(130)
	OUT  0x6,R30
...
_0xE:
	RJMP _0xD
_0xF:
; 0000 00AB             PORTC = 0x03;
	LDI  R30,LOW(3)
	OUT  0x15,R30
; 0000 00AC         }
; 0000 00AD         if (data>64 && data<=96){
_0xD:
	LDI  R30,LOW(64)
	CP   R30,R5
	BRSH _0x11
...
_0x11:
	RJMP _0x10
_0x12:
; 0000 00AE             PORTC = 0x07;
	LDI  R30,LOW(7)
	OUT  0x15,R30
; 0000 00AF         }
; 0000 00B0         if (data>96 && data<=128){
_0x10:
	LDI  R30,LOW(96)
	CP   R30,R5
	BRSH _0x14
...
_0x14:
	RJMP _0x13
_0x15:
; 0000 00B1             PORTC = 0x0f;
	LDI  R30,LOW(15)
	OUT  0x15,R30
; 0000 00B2         }
; 0000 00B3         if (data>128 && data<=160){
_0x13:
	LDI  R30,LOW(128)
	CP   R30,R5
	BRSH _0x17
...
_0x17:
	RJMP _0x16
_0x18:
; 0000 00B4             PORTC = 0x1f;
	LDI  R30,LOW(31)
	OUT  0x15,R30
; 0000 00B5         }
; 0000 00B6         if (data>160 && data<=192){
_0x16:
	LDI  R30,LOW(160)
	CP   R30,R5
	BRSH _0x1A
...
_0x1A:
	RJMP _0x19
_0x1B:
; 0000 00B7             PORTC = 0x3f;
	LDI  R30,LOW(63)
	OUT  0x15,R30
; 0000 00B8         }
; 0000 00B9         if (data>192 && data<=224){
_0x19:
	LDI  R30,LOW(192)
	CP   R30,R5
	BRSH _0x1D
...
_0x1D:
	RJMP _0x1C
_0x1E:
; 0000 00BA             PORTC = 0x7f;
	LDI  R30,LOW(127)
	OUT  0x15,R30
; 0000 00BB         }
; 0000 00BC         if (data>224 && data<=255){
_0x1C:
	LDI  R30,LOW(224)
	CP   R30,R5
	BRSH _0x20
