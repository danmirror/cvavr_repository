...
_0x0:
	.DB  0x25,0x33,0x2C,0x34,0x66,0x20,0x56,0x6F
	.DB  0x6C,0x74,0x0
_0x2000000:
...
; 0000 0098 ADMUX=ADC_VREF_TYPE;
	LDI  R30,LOW(0)
	OUT  0x7,R30
; 0000 0099 ADCSRA=(1<<ADEN) | (0<<ADSC) | (0<<ADATE) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (1<<ADPS1) | (0<<ADPS0);
	LDI  R30,LOW(130)
	OUT  0x6,R30
...
; 0000 00B4       data = read_adc(0);
	LDI  R26,LOW(0)
	RCALL _read_adc
	MOVW R4,R30
; 0000 00B5       Voltase = ((float)data)/1024*5;
	CLR  R22
	CLR  R23
	RCALL __CDF1
	MOVW R26,R30
	...
	STS  _Voltase+2,R22
	STS  _Voltase+3,R23
; 0000 00B6       //dtostrf(data, 3, 4, value);
; 0000 00B7       sprintf(kata1, "%3,4f Volt", kata1);
	LDI  R30,LOW(_kata1)
	LDI  R31,HIGH(_kata1)
	RCALL SUBOPT_0x0
	__POINTW1FN _0x0,0
	...
	RCALL _sprintf
	ADIW R28,8
; 0000 00B8       //ftoa(data,2,kata1);
; 0000 00B9       lcd_gotoxy(0,0);
	LDI  R30,LOW(0)
	ST   -Y,R30
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 00BA       lcd_puts(kata1,);
	LDI  R26,LOW(_kata1)
	LDI  R27,HIGH(_kata1)
	RCALL _lcd_puts
