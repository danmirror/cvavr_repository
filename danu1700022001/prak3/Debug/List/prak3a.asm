...
;unsigned char A;
;void lampu_pantul(){
; 0000 001D void lampu_pantul(){

	.CSEG
_lampu_pantul:
; .FSTART _lampu_pantul
; 0000 001E  unsigned char i;
; 0000 001F  for (i=0; i<4; i++){
	ST   -Y,R17
;	i -> R17
	LDI  R17,LOW(0)
_0x4:
...
; 0000 0085 ASSR=0<<AS2;
	OUT  0x22,R30
; 0000 0086 TCCR2=(0<<WGM20) | (0<<COM21) | (0<<COM20) | (0<<WGM21) | (0<<CS22) | (0<<CS21) | (0<<CS20);
	OUT  0x25,R30
...
; 0000 0090 // INT1: On
; 0000 0091 // INT1 Mode: Rising Edge
; 0000 0092 // INT2: Off
; 0000 0093 GICR|=(1<<INT1) | (1<<INT0) | (0<<INT2);
	IN   R30,0x3B
	ORI  R30,LOW(0xC0)
	OUT  0x3B,R30
...
; 0000 0095 MCUCSR=(0<<ISC2);
	LDI  R30,LOW(0)
	OUT  0x34,R30
; 0000 0096 GIFR=(1<<INTF1) | (1<<INTF0) | (0<<INTF2);
	LDI  R30,LOW(192)
	OUT  0x3A,R30
; 0000 0097 
