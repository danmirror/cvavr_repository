...
_0x0:
	.DB  0x2A,0x6B,0x65,0x79,0x70,0x61,0x64,0x20
	.DB  0x74,0x6F,0x20,0x6C,0x63,0x64,0x0,0x6B
	.DB  0x65,0x79,0x70,0x61,0x64,0x20,0x3A,0x20
	.DB  0x0,0x25,0x63,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 003F // Function: Bit7=Out Bit6=Out Bit5=Out Bit4=Out Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 0040 DDRD=(1<<DDD7) | (1<<DDD6) | (1<<DDD5) | (1<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	LDI  R30,LOW(240)
	OUT  0x11,R30
; 0000 0041 // State: Bit7=0 Bit6=0 Bit5=0 Bit4=0 Bit3=P Bit2=P Bit1=P Bit0=P
...
; 0000 00A1      lcd_gotoxy(0,0);
	...
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 00A2      lcd_putsf("*keypad to lcd");
	__POINTW2FN _0x0,0
	RCALL _lcd_putsf
...
; 0000 00A7 
; 0000 00A8 
; 0000 00A9      sprintf(kata, "%c" ,scankey);
	LDI  R30,LOW(_kata)
	LDI  R31,HIGH(_kata)
	RCALL SUBOPT_0x0
	__POINTW1FN _0x0,25
...
;
;void scan_key(void){
; 0000 00B1 void scan_key(void){
_scan_key:
; .FSTART _scan_key
; 0000 00B2     PORTD.4 = 0;
	CBI  0x12,4
; 0000 00B3     scan = (~PIND & 0x0F);
	RCALL SUBOPT_0x2
; 0000 00B4     switch(scan){
; 0000 00B5         case 1:
	BRNE _0xC
; 0000 00B6             scankey = '1';
	LDI  R30,LOW(49)
...
; 0000 00C4     PORTD.5=0;
	CBI  0x12,5
; 0000 00C5     scan = (~PIND & 0x0f);
	RCALL SUBOPT_0x2
; 0000 00C6 
; 0000 00C7     switch(scan){
; 0000 00C8         case 1:
	BRNE _0x17
; 0000 00C9             scankey = '2';
	LDI  R30,LOW(50)
...
; 0000 00D6     PORTD.6=0;
	CBI  0x12,6
; 0000 00D7     scan = (~PIND & 0x0f);
	RCALL SUBOPT_0x2
; 0000 00D8     switch(scan){
; 0000 00D9         case 1:
	BRNE _0x22
; 0000 00DA             scankey = '3';
	LDI  R30,LOW(51)
...
; 0000 00E7     PORTD.7=0;
	CBI  0x12,7
; 0000 00E8     scan = (~PIND & 0x0F);
	RCALL SUBOPT_0x2
; 0000 00E9     switch(scan){
; 0000 00EA         case 1:
	BRNE _0x2D
; 0000 00EB             scankey = 'A';
	LDI  R30,LOW(65)
