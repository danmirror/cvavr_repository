...
_0x0:
	.DB  0x70,0x72,0x61,0x6B,0x74,0x2C,0x20,0x4D
	.DB  0x69,0x6B,0x72,0x6F,0x20,0x55,0x41,0x44
	.DB  0x0,0x41,0x54,0x4D,0x45,0x4C,0x20,0x41
	.DB  0x56,0x52,0x20,0x38,0x35,0x33,0x35,0x0
	.DB  0x50,0x72,0x6F,0x64,0x69,0x20,0x54,0x20
	.DB  0x45,0x6C,0x65,0x6B,0x74,0x72,0x6F,0x0
	.DB  0x73,0x65,0x6D,0x65,0x73,0x74,0x65,0x72
	.DB  0x20,0x56,0x0,0x63,0x6F,0x6E,0x74,0x6F
	.DB  0x68,0x20,0x70,0x65,0x72,0x69,0x6E,0x74
	.DB  0x61,0x68,0x0,0x25,0x75,0x0,0x25,0x69
	.DB  0x0,0x25,0x64,0x0,0x25,0x78,0x0,0x25
...
; 0000 0091 // RS - PORTB Bit 0
; 0000 0092 // RD - PORTB Bit 1
; 0000 0093 // EN - PORTB Bit 2
...
; 0000 009F       lcd_gotoxy(0,0);
	RCALL SUBOPT_0x0
	RCALL SUBOPT_0x1
; 0000 00A0       lcd_putsf("prakt, Mikro UAD");
	__POINTW2FN _0x0,0
	RCALL _lcd_putsf
; 0000 00A1       lcd_gotoxy(0,1);
	RCALL SUBOPT_0x0
	RCALL SUBOPT_0x2
; 0000 00A2       lcd_putsf("ATMEL AVR 8535");
	__POINTW2FN _0x0,17
	RCALL SUBOPT_0x3
; 0000 00A3       delay_ms(1000);
; 0000 00A4       lcd_clear();
; 0000 00A5 
; 0000 00A6       lcd_putsf("Prodi T Elektro");
	__POINTW2FN _0x0,32
	RCALL _lcd_putsf
; 0000 00A7       lcd_gotoxy(0,1);
	RCALL SUBOPT_0x0
	RCALL SUBOPT_0x2
; 0000 00A8       lcd_putsf("semester V");
	__POINTW2FN _0x0,48
	RCALL SUBOPT_0x3
...
; 0000 00AC       lcd_gotoxy(0,0);
	RCALL SUBOPT_0x0
	RCALL SUBOPT_0x1
; 0000 00AD       lcd_putchar(0x41);
	LDI  R26,LOW(65)
	RCALL _lcd_putchar
; 0000 00AE       lcd_gotoxy(2,0);
	LDI  R30,LOW(2)
	RCALL SUBOPT_0x4
; 0000 00AF       lcd_putchar(0x42);
	LDI  R26,LOW(66)
	RCALL _lcd_putchar
; 0000 00B0       lcd_gotoxy(4,0);
	LDI  R30,LOW(4)
	RCALL SUBOPT_0x4
; 0000 00B1       lcd_putchar(0x43);
	LDI  R26,LOW(67)
	RCALL _lcd_putchar
; 0000 00B2       lcd_gotoxy(6,0);
	LDI  R30,LOW(6)
	RCALL SUBOPT_0x4
; 0000 00B3       lcd_putchar(0xE0);
	LDI  R26,LOW(224)
	RCALL _lcd_putchar
; 0000 00B4       lcd_gotoxy(8,0);
	LDI  R30,LOW(8)
	RCALL SUBOPT_0x4
; 0000 00B5       lcd_putchar(0xE2);
	LDI  R26,LOW(226)
	RCALL _lcd_putchar
; 0000 00B6       lcd_gotoxy(10,0);
	LDI  R30,LOW(10)
	RCALL SUBOPT_0x4
; 0000 00B7       lcd_putchar(0xE4);
	LDI  R26,LOW(228)
	RCALL _lcd_putchar
; 0000 00B8       lcd_gotoxy(12,0);
	LDI  R30,LOW(12)
	RCALL SUBOPT_0x4
; 0000 00B9       lcd_putchar(0xF4);
	LDI  R26,LOW(244)
	RCALL _lcd_putchar
; 0000 00BA       lcd_gotoxy(14,0);
	LDI  R30,LOW(14)
	RCALL SUBOPT_0x4
; 0000 00BB       lcd_putchar(0xF4);
	LDI  R26,LOW(244)
	RCALL _lcd_putchar
; 0000 00BC       lcd_gotoxy(0,1);
	RCALL SUBOPT_0x0
	RCALL SUBOPT_0x2
; 0000 00BD       lcd_putsf("contoh perintah");
	__POINTW2FN _0x0,59
	RCALL _lcd_putsf
...
; 0000 00BF       angka = 13;
	LDI  R30,LOW(13)
	MOV  R5,R30
; 0000 00C0       bilangan= ((float)angka);
	RCALL SUBOPT_0x5
	STS  _bilangan,R30
	STS  _bilangan+1,R31
	STS  _bilangan+2,R22
...
; 0000 00C1       lcd_clear();
	RCALL _lcd_clear
; 0000 00C2       sprintf(kata,"%u", angka);
	RCALL SUBOPT_0x6
	__POINTW1FN _0x0,75
	RCALL SUBOPT_0x7
; 0000 00C3       lcd_gotoxy(0,0);
	RCALL SUBOPT_0x0
	RCALL SUBOPT_0x1
; 0000 00C4       sprintf(kata,"%i", angka);
	RCALL SUBOPT_0x6
	__POINTW1FN _0x0,78
	RCALL SUBOPT_0x7
; 0000 00C5       lcd_gotoxy(4,0);
	LDI  R30,LOW(4)
	RCALL SUBOPT_0x4
; 0000 00C6       sprintf(kata,"%d", angka);
	RCALL SUBOPT_0x6
	__POINTW1FN _0x0,81
	RCALL SUBOPT_0x7
; 0000 00C7       lcd_gotoxy(8,0);
	LDI  R30,LOW(8)
	RCALL SUBOPT_0x4
; 0000 00C8       sprintf(kata,"%x", angka);
	RCALL SUBOPT_0x6
	__POINTW1FN _0x0,84
	RCALL SUBOPT_0x7
; 0000 00C9       lcd_gotoxy(12,0);
	LDI  R30,LOW(12)
	RCALL SUBOPT_0x4
; 0000 00CA       sprintf(kata,"%2.2f", angka);
	RCALL SUBOPT_0x6
	__POINTW1FN _0x0,87
	RCALL SUBOPT_0x7
; 0000 00CB       lcd_gotoxy(0,1);
	RCALL SUBOPT_0x0
	RCALL SUBOPT_0x2
; 0000 00CC       lcd_puts(kata);
	LDI  R26,LOW(_kata)
	LDI  R27,HIGH(_kata)
	RCALL _lcd_puts
; 0000 00CD       sprintf(kata,"%2.2f",bilangan);
	RCALL SUBOPT_0x6
	__POINTW1FN _0x0,87
	RCALL SUBOPT_0x8
	LDS  R30,_bilangan
