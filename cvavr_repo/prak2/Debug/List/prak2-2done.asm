...
; 0000 0037 // Function: Bit7=Out Bit6=Out Bit5=Out Bit4=Out Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 0038 DDRD=(1<<DDD7) | (1<<DDD6) | (1<<DDD5) | (1<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	LDI  R30,LOW(240)
	OUT  0x11,R30
; 0000 0039 // State: Bit7=0 Bit6=0 Bit5=0 Bit4=0 Bit3=P Bit2=P Bit1=P Bit0=P
...
;
;void scan_key(void){
; 0000 0093 void scan_key(void){
_scan_key:
; .FSTART _scan_key
; 0000 0094     PORTD.4 = 0;
	CBI  0x12,4
; 0000 0095     scan = (~PIND & 0x0F);
	RCALL SUBOPT_0x0
; 0000 0096     switch(scan){
; 0000 0097         case 1:
	BRNE _0xC
; 0000 0098             scankey = 0x1;
	LDI  R30,LOW(1)
	RJMP _0x33
; 0000 0099             break;
; 0000 009A         case 2:
...
; 0000 00A6     PORTD.5=0;
	CBI  0x12,5
; 0000 00A7     scan = (~PIND & 0x0f);
	RCALL SUBOPT_0x0
; 0000 00A8 
; 0000 00A9     switch(scan){
; 0000 00AA         case 1:
	BRNE _0x17
; 0000 00AB             scankey = 0x2;
	LDI  R30,LOW(2)
	MOV  R4,R30
; 0000 00AC             break;
	RJMP _0x16
...
; 0000 00B8     PORTD.6=0;
	CBI  0x12,6
; 0000 00B9     scan = (~PIND & 0x0f);
	RCALL SUBOPT_0x0
; 0000 00BA     switch(scan){
; 0000 00BB         case 1:
	BRNE _0x22
; 0000 00BC             scankey = 0x3;
	LDI  R30,LOW(3)
	RJMP _0x34
; 0000 00BD             break;
; 0000 00BE         case 2:
...
; 0000 00C9     PORTD.7=0;
	CBI  0x12,7
; 0000 00CA     scan = (~PIND & 0x0f);
	RCALL SUBOPT_0x0
; 0000 00CB     switch(scan){
; 0000 00CC         case 1:
	BRNE _0x2D
; 0000 00CD             scankey = 0xa;
	LDI  R30,LOW(10)
	RJMP _0x35
; 0000 00CE             break;
; 0000 00CF         case 2:
