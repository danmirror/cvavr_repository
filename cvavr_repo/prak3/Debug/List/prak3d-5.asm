...
_0x0:
	.DB  0x77,0x61,0x6B,0x74,0x75,0x20,0x61,0x6E
	.DB  0x64,0x61,0x20,0x68,0x61,0x62,0x69,0x73
	.DB  0x0,0x6C,0x65,0x62,0x69,0x68,0x20,0x64
	.DB  0x72,0x20,0x31,0x36,0x2C,0x37,0x37,0x73
	.DB  0x0,0x74,0x69,0x6D,0x65,0x72,0x20,0x31
	.DB  0x20,0x6F,0x66,0x66,0x0,0x62,0x75,0x74
	.DB  0x74,0x6F,0x6E,0x20,0x30,0x20,0x20,0x75
	.DB  0x74,0x6B,0x20,0x6F,0x6E,0x0,0x74,0x69
	.DB  0x6D,0x65,0x72,0x20,0x31,0x20,0x6F,0x6E
	.DB  0x0,0x74,0x69,0x6D,0x65,0x72,0x31,0x3A
	.DB  0x20,0x25,0x36,0x64,0x0,0x77,0x61,0x6B
	.DB  0x74,0x75,0x3A,0x20,0x25,0x33,0x66,0x20
	.DB  0x73,0x0
_0x2020003:
	.DB  0x80,0xC0
...
; 0000 0029    lcd_gotoxy(0,0);
	RCALL SUBOPT_0x0
	RCALL SUBOPT_0x1
; 0000 002A    lcd_putsf("waktu anda habis");
	__POINTW2FN _0x0,0
	RCALL _lcd_putsf
; 0000 002B    lcd_gotoxy(0,1);
	RCALL SUBOPT_0x0
	RCALL SUBOPT_0x2
; 0000 002C    lcd_putsf("lebih dr 16,77s");
	__POINTW2FN _0x0,17
	RCALL _lcd_putsf
...
; 0000 0061 // Timer1 Overflow Interrupt: On
...
; 0000 007B TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (1<<TOIE1) | (0<<OCIE0) | (0<<TOIE0);
	LDI  R30,LOW(4)
	OUT  0x39,R30
; 0000 007C 
...
; 0000 00B2         lcd_gotoxy(0,0);
	RCALL SUBOPT_0x0
	RCALL SUBOPT_0x1
; 0000 00B3         lcd_putsf("timer 1 off");
	__POINTW2FN _0x0,33
	RCALL _lcd_putsf
; 0000 00B4         lcd_gotoxy(0,1);
	RCALL SUBOPT_0x0
	RCALL SUBOPT_0x2
; 0000 00B5         lcd_putsf("button 0  utk on");
	__POINTW2FN _0x0,45
	RCALL _lcd_putsf
; 0000 00B6       };
	RJMP _0x6
...
; 0000 00BD         lcd_gotoxy(0,0);
	RCALL SUBOPT_0x0
	RCALL SUBOPT_0x1
; 0000 00BE         lcd_putsf("timer 1 on");
	__POINTW2FN _0x0,62
	RCALL _lcd_putsf
; 0000 00BF         lcd_gotoxy(0,1);
	RCALL SUBOPT_0x0
	RCALL SUBOPT_0x2
; 0000 00C0         lcd_putsf("button 0  utk on");
	__POINTW2FN _0x0,45
	RCALL _lcd_putsf
...
; 0000 00C2       };
	RJMP _0xC
_0xE:
; 0000 00C3       while(PIND.0!=0){
_0xF:
	SBIC 0x10,0
; 0000 00C4         //menunggu di lepas
; 0000 00C5       };
	RJMP _0xF
; 0000 00C6       lcd_clear();
	RCALL _lcd_clear
; 0000 00C7       sprintf(kata,"timer1: %6d",TCNT1);
	RCALL SUBOPT_0x3
	__POINTW1FN _0x0,73
	RCALL SUBOPT_0x4
	IN   R30,0x2C
...
; 0000 00C8       lcd_gotoxy(0,0);
	RCALL SUBOPT_0x1
; 0000 00C9       lcd_puts(kata);
	LDI  R26,LOW(_kata)
	LDI  R27,HIGH(_kata)
	RCALL _lcd_puts
; 0000 00CA       detik = ((float) (TCNT1)*0.256/1000);
	IN   R30,0x2C
	IN   R31,0x2C+1
	CLR  R22
	CLR  R23
	...
	STS  _detik+2,R22
	STS  _detik+3,R23
; 0000 00CB       sprintf(kata,"waktu: %3f s",  detik);
	RCALL SUBOPT_0x3
	__POINTW1FN _0x0,85
	RCALL SUBOPT_0x4
	LDS  R30,_detik
...
; 0000 00CC       lcd_gotoxy(0,1);
	RCALL SUBOPT_0x2
; 0000 00CD       lcd_puts(kata);
	LDI  R26,LOW(_kata)
	LDI  R27,HIGH(_kata)
	RCALL _lcd_puts
; 0000 00CE       TCNT1= 0x00;
	LDI  R30,LOW(0)
	LDI  R31,HIGH(0)
	OUT  0x2C+1,R31
	OUT  0x2C,R30
