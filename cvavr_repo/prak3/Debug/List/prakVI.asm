...
_0x0:
	.DB  0x61,0x64,0x61,0x20,0x25,0x2D,0x75,0x20
	.DB  0x44,0x53,0x31,0x38,0x42,0x32,0x30,0xA
	.DB  0xD,0x0,0x74,0x69,0x64,0x61,0x6B,0x20
	.DB  0x61,0x64,0x61,0x20,0x44,0x53,0x31,0x38
	.DB  0x42,0x32,0x30,0x0,0x73,0x75,0x68,0x75
	.DB  0x20,0x74,0x65,0x72,0x75,0x6B,0x75,0x72
	.DB  0x0,0x65,0x72,0x72,0x6F,0x72,0x0,0x74
	.DB  0x25,0x2D,0x75,0x3D,0x25,0x2D,0x69,0x2E
	.DB  0x25,0x2D,0x75,0xA,0xD,0x0
_0x2020060:
	.DB  0x1
_0x2020000:
...
; 0000 0094 TWCR=(0<<TWEA) | (0<<TWSTA) | (0<<TWSTO) | (0<<TWEN) | (0<<TWIE);
	OUT  0x36,R30
; 0000 0095 
; 0000 0096 // 1 Wire Bus initialization
; 0000 0097 // 1 Wire Data port: PORTC
; 0000 0098 // 1 Wire Data bit: 0
; 0000 0099 // Note: 1 Wire port settings are specified in the
; 0000 009A // Project|Configure|C Compiler|Libraries|1 Wire menu.
; 0000 009B w1_init();
	RCALL _w1_init
; 0000 009C 
...
; 0000 00A8 lcd_init(16);
	LDI  R26,LOW(16)
	RCALL _lcd_init
; 0000 00A9 ds18b20_device=w1_search(0xf0, ds18b20_rom_codes);
	LDI  R30,LOW(240)
	ST   -Y,R30
	...
	RCALL _w1_search
	MOV  R5,R30
; 0000 00AA sprintf(kata,"ada %-u DS18B20\n\r",ds18b20_device);
	RCALL SUBOPT_0x0
	__POINTW1FN _0x0,0
	RCALL SUBOPT_0x1
	MOV  R30,R5
...
; 0000 00AB lcd_gotoxy(0,0);
	RCALL SUBOPT_0x3
; 0000 00AC lcd_puts(kata);
	RCALL SUBOPT_0x4
; 0000 00AD delay_ms(200);
; 0000 00AE 
; 0000 00AF if(ds18b20_device==0)
	TST  R5
	BRNE _0x3
; 0000 00B0 while (1){
_0x4:
; 0000 00B1     lcd_gotoxy(0,0);
	RCALL SUBOPT_0x3
; 0000 00B2     lcd_putsf("tidak ada DS18B20");
	__POINTW2FN _0x0,18
	RCALL _lcd_putsf
...
; 0000 00B4     };
	RJMP _0x4
_0x3:
; 0000 00B5     for(i=0;i<ds18b20_device;i++){
	CLR  R4
_0x8:
	CP   R4,R5
	BRSH _0x9
; 0000 00B6         lcd_clear();
	RCALL _lcd_clear
; 0000 00B7         if(ds18b20_init(&ds18b20_rom_codes[i][0],25,35,DS18B20_12BIT_RES))
	RCALL SUBOPT_0x6
	RCALL SUBOPT_0x1
	LDI  R30,LOW(25)
	ST   -Y,R30
	...
	CPI  R30,0
	BREQ _0xA
; 0000 00B8             lcd_putsf("suhu terukur");
	__POINTW2FN _0x0,36
	RJMP _0x13
; 0000 00B9         else lcd_putsf("error");
_0xA:
	__POINTW2FN _0x0,49
_0x13:
	RCALL _lcd_putsf
...
; 0000 00BF         for(i=0;i<ds18b20_device;)
	CLR  R4
_0x10:
	CP   R4,R5
	BRSH _0x11
; 0000 00C0       {
; 0000 00C1 
; 0000 00C2         temp=ds18b20_temperature(ds18b20_rom_codes[i]);
	RCALL SUBOPT_0x6
	MOVW R26,R30
	RCALL _ds18b20_temperature
	RCALL __CFD1
	MOVW R6,R30
; 0000 00C3         sprintf(kata,"t%-u=%-i.%-u\n\r",++i,temp,abs(temp%10));
	RCALL SUBOPT_0x0
	__POINTW1FN _0x0,55
	RCALL SUBOPT_0x1
	INC  R4
