...
_0x0:
	.DB  0x74,0x65,0x6C,0x61,0x68,0x20,0x6F,0x76
	.DB  0x65,0x72,0x66,0x6C,0x6F,0x77,0x0,0x6B
	.DB  0x65,0x6D,0x62,0x61,0x6C,0x69,0x20,0x6B
	.DB  0x65,0x20,0x32,0x34,0x30,0x0,0x63,0x6F
	.DB  0x75,0x6E,0x74,0x65,0x72,0x30,0x3A,0x20
	.DB  0x0,0x25,0x33,0x64,0x0,0x6D,0x75,0x6C
	.DB  0x61,0x69,0x20,0x64,0x61,0x72,0x69,0x20
	.DB  0x32,0x34,0x30,0x0
_0x2020003:
	.DB  0x80,0xC0
...
; 0000 0028     lcd_gotoxy(0,0);
	...
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 0029     lcd_putsf("telah overflow");
	__POINTW2FN _0x0,0
	RCALL _lcd_putsf
; 0000 002A     lcd_gotoxy(0,1);
	...
	LDI  R26,LOW(1)
	RCALL _lcd_gotoxy
; 0000 002B     lcd_putsf("kembali ke 240");
	__POINTW2FN _0x0,15
	RCALL _lcd_putsf
; 0000 002C 
; 0000 002D 
; 0000 002E     TCNT0=0xf7;
	LDI  R30,LOW(247)
	OUT  0x32,R30
...
; 0000 0051 // Clock source: T0 pin Rising Edge
; 0000 0052 // Mode: Normal top=0xFF
; 0000 0053 // OC0 output: Disconnected
; 0000 0054 TCCR0=(0<<WGM00) | (0<<COM01) | (0<<COM00) | (0<<WGM01) | (1<<CS02) | (1<<CS01) | (1<<CS00);
	LDI  R30,LOW(7)
	OUT  0x33,R30
; 0000 0055 TCNT0=0xfa;
	LDI  R30,LOW(250)
	OUT  0x32,R30
; 0000 0056 OCR0=0x00;
	LDI  R30,LOW(0)
...
; 0000 00B0         lcd_gotoxy(0,0);
	...
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 00B1         lcd_putsf("counter0: ");
	__POINTW2FN _0x0,30
	RCALL _lcd_putsf
; 0000 00B2         lcd_gotoxy(10,0);
	LDI  R30,LOW(10)
	ST   -Y,R30
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 00B3         sprintf(kata, "%3d", TCNT0);
	LDI  R30,LOW(_kata)
	LDI  R31,HIGH(_kata)
	RCALL SUBOPT_0x1
	__POINTW1FN _0x0,41
...
; 0000 00B5         lcd_gotoxy(0,1);
	...
	LDI  R26,LOW(1)
	RCALL _lcd_gotoxy
; 0000 00B6         lcd_putsf("mulai dari 240");
	__POINTW2FN _0x0,45
	RCALL _lcd_putsf
; 0000 00B7 
; 0000 00B8       }
